...
const getHeroLikeProps = (section: PageSection): HeroLikeProps => ({
  ...
  desktopBackgroundImage: section.desktopBackgroundImage as
    | SanityImage
    | undefined,
  mobileBackgroundImage: section.mobileBackgroundImage as
    | SanityImage
    | undefined,
  desktopBackgroundVideo: section.desktopBackgroundVideo as
    | SanityVideo
    | undefined,
  videoSource: section.videoSource as VideoSource,
  desktopBackgroundVideoUrl: section.desktopBackgroundVideoUrl as
    | string
    | undefined,
  desktopBackgroundVideoPlaceholder:
    section.desktopBackgroundVideoPlaceholder as SanityImage | undefined,
...
export default async function DynamicPage({ params }: PageProps) {
  ...
  const page = await clientNoCdn.fetch(
    pageQuery,
  ...
  const getSections = () => {
    ...
    switch (page.pageType) {
      ...
      case "heritage":
        addSection(
          sections,
          page.heritageTextWithArtefacts,
          "textWithArtefacts",
          "heritage-text-with-artefacts",
        );
        addSection(
          sections,
          page.heritageTextWithArtefacts2,
          "textWithArtefacts",
          "heritage-text-with-artefacts-2",
        );
        addSection(
          sections,
          page.heritageImageCarousel,
          "imageCarousel",
          "heritage-image-carousel",
        );
      ...
      case "carousel":
        addSection(
          sections,
          page.carouselTextWithArtefacts,
          "textWithArtefacts",
          "carousel-text-with-artefacts",
        );
        addSection(
          sections,
          page.carouselFullWidthMedia,
          "fullWidthMedia",
          "carousel-full-width-media",
        );
        addSection(
          sections,
          page.carouselImageMasonry,
          "imageMasonry",
          "carousel-image-masonry",
        );
        addSection(
          sections,
          page.carouselPlanYourVisit,
          "planYourVisit",
          "carousel-plan-your-visit",
        );
  ...
  if (page.pageType === "general" && page.contentBlocks) {
    return (
      <>
        <BodyClassProvider pageType={page.pageType} slug={page.slug?.current} />
  ...
  const pressContentBlocks =
    page.pageType === "press" ? page.pressContentBlocks : null;
  const eventsContentBlocks =
    page.pageType === "events" ? page.eventsContentBlocks : null;
  const flexibleBlocks = [pressContentBlocks, eventsContentBlocks].filter(
    Boolean,
  );
  ...
  return (
    <>
      ...
      {sections.map((section: PageSection) => {
        const Component =
          sectionComponents[section._type as keyof typeof sectionComponents];
        ...
        if (section._type === "stackedMediaText") {
          ...
          const StackedMediaTextComponent =
            Component as typeof StackedMediaText;
          return (
        ...
        if (section._type === "architects") {
          // Extract the individual props from the section data
          const { heading, body, architects } = section;
        ...
        if (section._type === "flexibleHeroSection") {
          ...
          const FlexibleHeroSectionComponent =
            Component as typeof FlexibleHeroSection;
          return (
        ...
        const GenericComponent = Component as React.ComponentType<
