            ...
            <div className="brand-directory-list__meta">
              ...
              <div className="link-wrap">
                <div className="category-icons">
                  {renderCategoryIcon(brand.categories)}
                </div>
    ...
    <>
      ...
      >
        <div className="brand-directory-scroll-sticky">
          <div
            className={`brand-directory-list h-pad ${items.length < 5 ? "has-few-items" : ""}`}
          >
            <BrandList
              items={items}
        ...
        {items.map((brand) => (
          <div key={brand.id} className="brand-directory-list-mobile__item">
            <Link
              ...
              onClick={touchDragClickGuard.onClick}
            >
              <span className="brand-directory-list__title h2">
                {brand.title}
              </span>
