...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description:
        "Optional. Select a category to have it preselected when the block loads. If no category is selected, all brands will be displayed.",
      type: "reference",
